function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>AppUser Kullanıcı Adı:</td><td> <a title="Icerik" href="/Admin/AppUser/ListAppUser/' + aData[1] +'">' + aData[2] + ' </a> </td></tr>';
    sOut += '<tr><td>AppUser Sifre:</td><td><a title="Acıklama" href="/Admin/AppUser/ListAppUser/' + aData[2] + '">' + aData[3] + ' </a></td></tr>';
    sOut += '</table>';
