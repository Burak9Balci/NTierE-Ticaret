function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Kategori ürün bilgisi:</td><td> <a title="Icerik" href="/Admin/Category/ListCategories/'+ aData[1] +'">'+aData[2]+' </a> </td></tr>';
    sOut += '<tr><td>Kategori Açıklaması:</td><td><a title="Acıklama" href="/Admin/Category/ListCategories/'+ aData[2] +'">'+aData[3]+' </a></td></tr>';
    sOut += '</table>';
