function fnFormatDetails(oTable, nTr) {
    ...
    sOut += '<tr><td>Ürün Ismi:</td><td> <a title="Icerik" href="/Admin/Product/ListProduct/' + aData[1] + '">' + aData[2] + ' </a> </td></tr>';
    sOut += '<tr><td>Urun Fiyatı:</td><td><a title="Acıklama" href="/Admin/Product/ListProduct/' + aData[2] + '">' + aData[3] + ' </a></td></tr>';
    sOut += '</table>';
